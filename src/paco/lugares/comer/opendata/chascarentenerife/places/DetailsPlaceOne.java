...
public class DetailsPlaceOne extends AsyncTask<String, Void, Boolean>{
	...
	protected Boolean doInBackground(String... args) {
		...
		try{
			// TODO: Cambiar la KEY
			String requesturl="https://maps.googleapis.com/maps/api/place/details/json?reference="+URLEncoder.encode(args[0], "UTF-8")+"&sensor=false&key="+ctx.getResources().getString(R.string.key_api_place);
